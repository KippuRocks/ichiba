// Extracts the strings Ichiba could show a buyer, and checks each against the
// vocabulary.
//
...
// every string value in a JSON file named explicitly. Import and export
// specifiers and type-level literals are code, not copy, and are skipped. Tests
// are skipped: they must be able to name the terms they check for.
